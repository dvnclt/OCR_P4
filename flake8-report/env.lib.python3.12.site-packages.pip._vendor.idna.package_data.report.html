...
<html>
   <head>
      <title>flake8 violations: env/lib/python3.12/site-packages/pip/_vendor/idna/package_data.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.lib.python3.12.site-packages.pip._vendor.idna.package_data.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.lib.python3.12.site-packages.pip._vendor.idna.package_data.source.html#l2">
                  <tt><i>2</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
