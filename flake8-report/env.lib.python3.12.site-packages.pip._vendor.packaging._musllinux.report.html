...
<html>
   <head>
      <title>flake8 violations: env/lib/python3.12/site-packages/pip/_vendor/packaging/_musllinux.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.lib.python3.12.site-packages.pip._vendor.packaging._musllinux.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.lib.python3.12.site-packages.pip._vendor.packaging._musllinux.source.html#l26">
                  <tt><i>26</i> <span class="sd">    ELF header: https://refspecs.linuxfoundation.org/elf/gabi4+/ch4.eheader.html</span></tt>
               </a>
            </li><li>
               
               <a href="env.lib.python3.12.site-packages.pip._vendor.packaging._musllinux.source.html#l106">
                  <tt><i>106</i>     <span class="n">proc</span> <span class="o">=</span> <span class="n">subprocess</span><span class="o">.</span><span class="n">run</span><span class="p">([</span><span class="n">ld</span><span class="p">],</span> <span class="n">stderr</span><span class="o">=</span><span class="n">subprocess</span><span class="o">.</span><span class="n">PIPE</span><span class="p">,</span> <span class="n">universal_newlines</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span></tt>
               </a>
            </li>
            </ul>
         </li>
